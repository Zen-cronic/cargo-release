...
export default defineConfig({
  ...
  webServer: [
    {
      command:
        'bash -lc \'export VIRTUAL_ENV=/home/zin-kg/.pyenv/versions/.cargo-release; export PATH="$VIRTUAL_ENV/bin:$PATH"; CARGO_RELEASE_DB=/tmp/cargo-release-e2e.db CARGO_RELEASE_GEMMA_CRITIC_ENABLED=1 CARGO_RELEASE_GEMMA_CRITIC_MODE=FIXTURE CARGO_RELEASE_EMBEDDING_RETRIEVAL_ENABLED=1 CARGO_RELEASE_EMBEDDING_RETRIEVAL_MODE=FIXTURE CARGO_RELEASE_VEO_REPLAY_ENABLED=1 CARGO_RELEASE_VEO_REPLAY_MODE=FIXTURE poetry run uvicorn cargo_release.api:app --host 127.0.0.1 --port 8095\'',
      cwd: "..",
